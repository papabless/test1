...
var odds = 0; // Chances of win
var next = 0; // Profit on next tile clicked
function startNewGame(){
    ...
    $.post("https://api.moneypot.com/v1/hashes?access_token="+getURLParameter('access_token'), '', function(json) {
        ...
        game = {
            ...
            tilesClicked: 0,
            odds: odds,
            next: next, // ( (( houseEdge / ( ((25-game.bombs)-game.tilesClicked) / (25-game.tilesClicked) ) )*game.bet)-game.bet ),
            stake: game.bet
        };
                ...
                $.ajax({
                    ...
                    data: JSON.stringify({
                        ...
                        "payouts": [
                            ...
                            {from: rangeLose, to: 4294967296, value: Math.ceil((game.stake+game.next)*100)}
                        ]
                    }),
                    dataType: "json",
                    ...
                    if(data.next_hash){
                        ...
                        if(data.outcome < rangeLose){
                            ...
                            odds = ( (25-game.bombs-game.tilesClicked) / (25-game.tilesClicked) );
                            next = ( game.stake * (0.99/odds) ) - game.stake;
                            game = {
                                status: "IN_PROGRESS",
                                profit: 0,
                                ...
                                odds: odds,
                                next: next, // ( (( houseEdge / ( (25-game.bombs-game.tilesClicked) / (25-game.tilesClicked) ) )*game.stake)-game.stake ),
