...
function setAudioMuted(){
    if(audioMuted == false){
        audioMuted = true;
        $('.audioMuteCheckbox').prop('checked', true);
    }else{
        audioMuted = false;
        $('.audioMuteCheckbox').prop('checked', false);
    }
