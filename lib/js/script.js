    ...
    socket.on('connect', function() {
        ...
        socket.emit('auth', authRequest, function(err, authResponse) {
            ...
            if(access_token!="" && access_token!=null){
                ...
                $.getJSON("https://api.moneypot.com/v1/list-bets?access_token="+access_token+"&app_id=1115&wager=100000&limit=11&order_by=desc", function(json){
