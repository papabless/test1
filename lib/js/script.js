...
function addNewChatMessage(data){
    ...
    chatMonitor.innerHTML += "<span class=\"chatMessage "+(notify?"notify":"")+"\" "+servStyle+"><small>"+date.hours+":"+date.mins+"</small> <b "+ownerStyle+"><b "+modStyle+">"+username+"</b>: "+message+"<br></span>";
    chatMonitor.scrollTop = chatMonitor.scrollHeight;
