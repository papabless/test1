...
$(function(){
    ...
    if(getURLParameter('access_token')!="" && getURLParameter('access_token')!=null){
        ...
        window.history.pushState('', 'Sweepabit', '/');
    }
    ...
    socket.on('connect', function() {
        ...
        socket.emit('auth', authRequest, function(err, authResponse) {
            ...
            if(access_token!="" && access_token!=null){
                ...
                $.getJSON("https://api.moneypot.com/v1/list-bets?access_token="+access_token+"&app_id=1115&wager=50000&limit=11&order_by=desc", function(json){
...
$('#cashoutButton').click(function(){
    ...
    $('#logs').html("<div class=\"log_item\" style=\"border-left: 4px solid #F39C12;\">Cashed out!<br>Profit: <span style=\"color: #F39C12\">"+(parseFloat(game.stake).formatMoney(2,'.',','))+"</span> Bits! <button id=\"playAgainButton\">Play Again</button></div>"+$('#logs').html());
