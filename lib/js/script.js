...
$(function(){
    ...
    socket.on('connect', function() {
        ...
        socket.emit('auth', authRequest, function(err, authResponse) {
            ...
            $('.safeLink').click(function(link){
                var link = $(this).text();
                $('#unknownLink').text(escapeHTML(link));
                $('#safeLinkForm').modal('setting', 'closable', false).modal('show');
                
                $("#safeLinkDoRedirectButton").bind("click", function(){
                    window.open(encodeURI(link));
                    $('#safeLinkForm').modal('hide');
                    $("#safeLinkDoRedirectButton").unbind("click");
                });
