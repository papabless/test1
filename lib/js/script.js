...
function startNewGame(){
    if(!connected){
        $('#theDimmer').html("Error: Not connected!<br><a href=\"https://www.moneypot.com/oauth/authorize?app_id=1115&response_type=token&state=Meh&redirect_uri=http://turtledaddykim.github.io/BitMine\">Click here to login</a>");
