...
if(typeof $.cookie('audioMuted') === "undefined"){
    var audioMuted = false;
    $.cookie('audioMuted', audioMuted);
}else{
    var audioMuted = $.cookie('audioMuted');
}
...
function showSettings(){
    $('#theDimmer').html("<label style=\"color:white;\">Bet:</label><input class=\"bet\" type=\"number\" pattern=\"[0-9]*\" value=\""+betSave+"\" onkeyup=\"setBet($(this).val());\" onchange=\"setBet($(this).val());\" style=\"color:black;width:150px;\"><br>"+
                        ...
                        "<label style=\"color:white;\">Client Seed:</label><input class=\"bet\" type=\"number\" pattern=\"[0-9]*\" value=\""+game.clientSeed+"\" onkeyup=\"setClientSeed($(this).val());\" onchange=\"setClientSeed($(this).val());\" style=\"color:black;width:150px;\"><br><div class=\"ui checkbox\"><input type=\"checkbox\" class=\"hidden\" onclick=\"setAudioMuted();\" "+(audioMuted?'checked':'')+"><label style=\"color:white;\">Mute Audio</div>");
    $('#game_left').dimmer('show');
    return;
}
