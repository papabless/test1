...
function addNewChatMessage(data){
    ...
    chatMonitor.innerHTML += "<span class=\"chatMessage "+(notify?"notify":"")+"\" "+servStyle+"><small>"+date.hours+":"+date.mins+"</small> <b "+modStyle+" onclick='$(\"#chatText\").val($(\"#chatText\").val()+\"@"+username+"\");'>"+username+"</b>: "+message+"<br></span>";
