            ...
            $(this).click(function(){
                ...
                $.ajax({
                    ...
                    data: JSON.stringify({
                        ...
                        wager: wager,
                        "payouts": [
                            {from: 0, to: rangeWin, value: Math.floor((game.stake+game.next)*100)},
                            {from: rangeWin+1, to: Math.pow(2,32)-1, value: 0}
                        ]
                    }),
                    dataType: "json",
                    ...
                    if(data.next_hash){
                        ...
                        if(data.outcome < rangeLose){
                            ...
                            odds = ( (25-game.bombs-game.tilesClicked) / (25-game.tilesClicked) );
                            next = ( game.stake * ((1.0-houseEdge)/odds) ) - game.stake;
                            game = {
                                status: "IN_PROGRESS",
                                profit: 0,
