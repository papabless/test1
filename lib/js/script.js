...
function startNewGame(){
    ...
    $('#next_value').text(parseFloat(game.next));
    $('#stake_value').text(parseFloat(game.stake));
    ...
    $(".tile").each(function(ndx){
        $(this).click(function(){
            ...
            var wager = Math.round(game.stake*100);
            ...
            $.ajax({
                ...
                if(data.next_hash){
                    ...
                    if(data.outcome < rageLose){
                        ...
                        self.addClass("pressed");
                        self.html("<span class=\"tile_val\">+"+(parseFloat(game.next))+"</span>");

                        $('#logs').html("<div class=\"log_item\" style=\"border-left: 4px solid #8D4;\">Clicked tile #"+ndx+"<br>Found: <span style=\"color: #8D4\">"+(parseFloat(game.next))+"</span> Bits!</div>"+$('#logs').html());
...
$('#cashoutButton').click(function(){
    ...
    $('#logs').html("<div class=\"log_item\" style=\"border-left: 4px solid #F39C12;\">Cashed out!<br>Profit: <span style=\"color: #F39C12\">"+(parseFloat(game.stake))+"</span> Bits!</div>"+$('#logs').html());
