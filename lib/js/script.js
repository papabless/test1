...
function startNewGame(){
    ...
    game = {
        ...
        next: ( (( 0.99/ ( ((25-game.bombs)-game.tilesClicked) / (25-game.tilesClicked) ) )*game.bet)-game.bet ),
        stake: game.bet
    };
                ...
                if(data.next_hash){
                    ...
                    if(data.outcome < rageLose){
                        ...
                        game = {
                            ...
                            odds: ( (25-game.bombs-game.tilesClicked) / (25-game.tilesClicked) ),
                            next: ( (( 0.99/ ( (25-game.bombs-game.tilesClicked) / (25-game.tilesClicked) ) )*game.stake)-game.stake ),
